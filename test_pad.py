...
def main():
    ...
    summary_path = 'summaries/20200903_112349'
    std_path = None
    pre_scaling = True
    method = 'crop'
    target_depth = 155
    pad = 5
    start = 0
    test_tfr_path = r'C:\BraTS\test\2020\*'
    ...
    for i, (x, name) in tqdm(enumerate(test_generator)):
        result = test_step(x)
        pad_result = utils.fixed_depth_crop(result, target_depth=target_depth, start=start, is_forward=False)
